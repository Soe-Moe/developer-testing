...
const ProductsHero: FC<ProductsHeroProps> = ({ title, description }) => {
  return (
    <section className="w-full flex flex-col items-center  ">
      <div className="flex flex-col  justify-between py-10 md:pt-28 md:pb-18 items-center gap-2 md:gap-5 w-full max-w-screen-xl mx-5 md:mx-20 text-center px-5 md:px-0">
